...
public:
	...
	PuzzleGame(const PuzzleGame&) = default; // copy constructor
	PuzzleGame& operator=(const PuzzleGame&) = default; // copy assignment
...
public:
	...
	/** @brief      increament the value of total moves used till a point*/
	void incTotalMove();
...
private:
	...
	size_t totalMoves;  // counts total moves
